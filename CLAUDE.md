...
| Execution-record retention (cap + auto-prune) | `services/execution_engine.py::prune_executions` + `Script.max_executions` (`V11`) + `routers/scripts.py` PATCH |
